...
const TweetSentimentCard = ({
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg shadow-lg p-4 flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6 w-full md:w-[800px] h-auto">
      {/* TweetDemo component */}
