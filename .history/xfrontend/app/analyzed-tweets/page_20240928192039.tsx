...
import { TweetDemo } from "@/components/magicui/marquee-demo"; // Import the TweetDemo component

const AnalyzedTweetsPage = () => {
  // Example submitted tweet URLs, replace with actual tweet URLs if available
