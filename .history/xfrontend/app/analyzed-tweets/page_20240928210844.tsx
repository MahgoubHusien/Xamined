  ...
  return (
    <Layout>
      <div className="flex flex-col md:flex-row h-screen p-4 md:p-8">
        <div className="w-full flex flex-wrap items-center justify-center gap-6 bg-white p-4 md:p-8">
...
// Card to display each tweet and its sentiment
const TweetSentimentCard = ({
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-lg shadow-lg p-4 flex flex-col md:flex-row items-center md:items-start space-y-4 md:space-y-0 md:space-x-6 w-full md:w-[800px] h-auto">
      {/* TweetDemo component */}
      <div className="w-full md:w-1/2 flex justify-center md:justify-start md:items-start">
        <div className="flex justify-center items-center md:mt-8"> {/* Adjust vertical position here */}
          <TweetDemo tweetUrl={tweet.url} />
        </div>
      </div>
      {/* RatingWithReasoning component */}
      <div className="w-full md:w-1/2 flex justify-center md:justify-start md:items-center">
        <RatingWithReasoning
