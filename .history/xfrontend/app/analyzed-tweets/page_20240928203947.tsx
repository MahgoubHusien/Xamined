...
const AnalyzedTweetsPage = () => {
  // Use URLs with full tweet links
  ...
  return (
    <Layout>
      <div className="flex flex-col md:flex-row h-screen p-4 md:p-8">
        <div className="w-full flex flex-col items-center bg-white p-4 md:p-8">
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-5xl">
      {tweets.map((tweet, index) => (
        <div key={index} className="bg-white border border-gray-200 rounded-lg shadow-lg p-4 flex flex-col items-center space-y-4 w-full h-auto">
