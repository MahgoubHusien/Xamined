        ...
        <div className="mt-14 md:mt-10 w-full">
          ...
          <div className="flex flex-col md:flex-row w-full max-w-4xl items-center justify-center gap-6 md:gap-8">
            ...
            <div className="w-full md:w-1/2 flex justify-center md:justify-center">
              <div className="scale-90 md:scale-100 w-full h-full flex items-center justify-center p-4 md:p-8 bg-white rounded-lg shadow-lg">
                <TweetDemo tweetUrl={"1836824626971955537"} />
              </div>
            </div>
            {/* Rating and Reasoning Section */}
            <div className="w-full md:w-1/2 flex justify-center md:justify-center">
              <div className="w-full h-full flex items-center justify-center p-4 md:p-8 bg-white rounded-lg shadow-lg">
                <RatingWithReasoning
