  ...
  return (
    <Layout>
      <div className="flex flex-col w-full min-h-screen items-center justify-center bg-gray-100 p-4">
        ...
        <div className="flex flex-col md:flex-row w-full max-w-5xl items-center justify-center gap-4"> {/* Adjust gap here */}
  {/* Tweet Demo Section */}
  <div className="w-full md:w-1/2 flex justify-end relative" style={{ top: '-180px' }}> {/* Move closer by decreasing the negative value */}
    <div className="scale-90 md:scale-100">
      <TweetDemo />
    </div>
  </div>
  {/* Rating and Reasoning Section */}
  <div className="w-full md:w-1/2 flex justify-start relative" style={{ transform: 'translateY(50px)' }}> {/* Move closer by decreasing the translate value */}
    <RatingWithReasoning
