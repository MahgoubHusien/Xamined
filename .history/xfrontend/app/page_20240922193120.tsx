  ...
  return (
    <Layout>
      <div className="flex flex-col w-full min-h-screen items-center justify-center bg-gray-100 p-4">
        ...
        <div className="flex flex-col md:flex-row w-full max-w-5xl items-center justify-center gap-2">
  {/* Tweet Demo Section */}
  <div className="w-full md:w-1/2 flex justify-end relative mr-10" style={{ top: '-193px', paddingRight: 0, marginRight: -8 }}> {/* Ensure no extra padding or margin */}
    <div className="scale-90 md:scale-100">
      <TweetDemo />
    </div>
  </div>
  {/* Rating and Reasoning Section */}
  <div className="w-full md:w-1/2 flex justify-start relative" style={{ transform: 'translateY(70px)', paddingLeft: 0, marginLeft: -16 }}> {/* Ensure no extra padding or margin */}
    <RatingWithReasoning
