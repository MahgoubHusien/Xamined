...
export default function LandingPage() {
  ...
  {/* Tweet Demo Section */}
  <div className="w-full md:w-1/2 flex justify-end relative" style={{ top: '-190px', paddingRight: 0, marginRight: -10 }}> {/* Ensure no extra padding or margin */}
    <div className="scale-90 md:scale-100">
      <TweetDemo />
    </div>
  </div>
  {/* Rating and Reasoning Section */}
  <div className="w-full md:w-1/2 flex justify-start relative" style={{ transform: 'translateY(70px)', paddingLeft: 0, marginLeft: -12 }}> {/* Ensure no extra padding or margin */}
    <RatingWithReasoning
