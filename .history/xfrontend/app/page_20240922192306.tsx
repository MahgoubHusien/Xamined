...
export default function LandingPage() {
  ...
  return (
    <Layout>
      ...
      {/* Tweet Demo Section */}
      <div className="w-full md:w-1/2 flex justify-end relative" style={{ top: '-260px' }}> 
        <div className="scale-90 md:scale-100">
          <TweetDemo />
        </div>
      </div>
      {/* Rating and Reasoning Section */}
      <div className="w-full md:w-1/2 flex justify-start relative" style={{ transform: 'translateY(50px)' }}> {/* Adjust the value to move down */}
        <RatingWithReasoning
