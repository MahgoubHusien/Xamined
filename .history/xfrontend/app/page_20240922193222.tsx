...
export default function LandingPage() {
  ...
  return (
    <Layout>
      <div className="flex flex-col w-full min-h-screen items-center justify-center bg-gray-100 p-4">
        ...
        <div className="flex flex-col md:flex-row w-full max-w-5xl items-center justify-center gap-2" style={{ transform: 'translateX(50px)' }}> {/* Adjust translateX as needed */}
  {/* Tweet Demo Section */}
  ...
  <div className="w-full md:w-1/2 flex justify-start relative" style={{ transform: 'translateY(70px)', paddingLeft: 0, marginLeft: -16 }}>
    <RatingWithReasoning
