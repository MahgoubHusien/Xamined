  ...
  return (
    <Layout>
      <div className="flex flex-col w-full min-h-screen items-center justify-center p-4 md:px-8">
        ...
        <div className="mt-14 md:mt-10 w-full">
          {/* Header Section */}
          ...
          {/* Content Section */}
          <div className="flex flex-col-reverse md:flex-row w-full max-w-4xl items-center justify-center gap-6 md:gap-8">
            {/* Rating and Reasoning Section */}
            <div className="w-full md:w-1/2 flex justify-center md:justify-end order-2 md:order-1">
              <div className="h-80 w-full max-w-xs md:max-w-md bg-neutral-900 rounded-lg p-4 shadow-lg">
                <RatingWithReasoning
            ...
            <div className="w-full md:w-1/2 flex justify-center md:justify-start mb-8 md:mb-0 order-1 md:order-2">
              <div className="h-80 w-full max-w-xs md:max-w-md bg-white rounded-lg p-4 shadow-lg">
