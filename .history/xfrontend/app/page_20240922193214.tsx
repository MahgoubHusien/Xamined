  ...
  return (
    <Layout>
      <div className="flex flex-col w-full min-h-screen items-center justify-center bg-gray-100 p-4">
        ...
        <div className="flex flex-col md:flex-row w-full max-w-5xl items-center justify-center gap-2" style={{ transform: 'translateX(30px)' }}> {/* Adjust translateX as needed */}
  {/* Tweet Demo Section */}
