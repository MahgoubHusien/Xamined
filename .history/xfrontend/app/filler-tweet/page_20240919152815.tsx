  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-center items-center bg-gray-900 text-white overflow-hidden">
      ...
      <div className="absolute top-20 left-10 z-50 m-4">
        <div className="text-6xl font-extrabold text-left text-neutral-100">
          Discover the Power of:
        </div>
        <FlipWords words={words} duration={3000} className="text-left text-6xl font-extrabold text-neutral-100" />

        {/* Mini About Section */}
        <div className="mt-6 text-2xl text-left text-neutral-300 max-w-sm">
