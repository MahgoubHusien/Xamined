  ...
  return (
    <Layout>
      <div className="flex flex-col w-full h-screen">
        ...
        {/* Content */}
        <div className="flex flex-row w-full flex-1 mt-4">
          {/* Left half */}
          <div className="flex flex-col justify-start items-center w-1/2 px-8">
          ...
          {/* Right half */}
          <div className="flex justify-start items-center w-1/2 px-8">
            <TweetDemo />
          </div>
        </div>
      </div>
