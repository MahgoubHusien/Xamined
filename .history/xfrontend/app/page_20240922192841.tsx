...
export default function LandingPage() {
  ...
  <div className="w-full md:w-1/2 flex justify-start relative" style={{ transform: 'translateY(70px)', paddingLeft: 0, marginLeft: -14 }}> {/* Ensure no extra padding or margin */}
    <RatingWithReasoning
