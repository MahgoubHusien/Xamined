  ...
  return (
    <Layout>
      <div className="flex flex-col w-full min-h-[120vh] items-center justify-center p-4">
        ...
        <div className="flex flex-col md:flex-row w-full max-w-5xl items-center justify-center gap-8 md:gap-4 px-4">
          <div className="w-full md:w-1/2 flex justify-center md:justify-end relative" style={{ top: '-100px' }}>
            <div className="scale-90 md:scale-100">
              <TweetDemo />
            </div>
          </div>
          <div className="w-full md:w-1/2 flex justify-center md:justify-start relative" style={{ transform: 'translateY(40px)' }}>
            <RatingWithReasoning
