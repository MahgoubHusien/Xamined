...
export default function LandingPage() {
  ...
  <div className="text-5xl font-bold text-black h-[100px] flex items-center justify-center" style={{ width: '600px' }}> {/* Fixed width container */}
    Xamine{" "}
    <span className="inline-block overflow-hidden">
      <FlipWords
        ...
        style={{ width: '150px', display: 'inline-block', textAlign: 'center' }} // Set a fixed width for FlipWords
      />
    </span>{" "}
  ...
  <div className="w-full md:w-1/2 flex justify-start relative" style={{ transform: 'translateY(85px)', paddingLeft: 0, marginLeft: -16 }}>
    <RatingWithReasoning
