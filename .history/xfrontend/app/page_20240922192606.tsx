  ...
  return (
    <Layout>
      <div className="flex flex-col w-full min-h-screen items-center justify-center bg-gray-100 p-4">
        ...
        <div className="flex flex-col md:flex-row w-full max-w-5xl items-center justify-between gap-2"> {/* Adjust gap as needed */}
  {/* Tweet and Rating in One Container */}
  <div className="flex items-center justify-center w-full">
    {/* Tweet Demo Section */}
    <div className="flex justify-end relative" style={{ top: '-180px' }}> {/* Adjust top value */}
      <div className="scale-90 md:scale-100">
        <TweetDemo />
      </div>
    </div>
    {/* Rating and Reasoning Section */}
    <div className="flex justify-start relative" style={{ transform: 'translateY(50px)' }}> {/* Adjust translate value */}
      <RatingWithReasoning
