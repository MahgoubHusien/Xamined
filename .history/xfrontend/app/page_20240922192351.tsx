  ...
  return (
    <Layout>
      <div className="flex flex-col w-full min-h-screen items-center justify-center bg-gray-100 p-4">
        ...
        {/* Tweet Demo Section */}
        <div className="w-full md:w-1/2 flex justify-end relative" style={{ top: '-1900px' }}> 
          <div className="scale-90 md:scale-100">
            <TweetDemo />
          </div>
        </div>
        {/* Rating and Reasoning Section */}
        <div className="w-full md:w-1/2 flex justify-start relative" style={{ transform: 'translateY(70px)' }}> {/* Adjust the value to move down */}
          <RatingWithReasoning
