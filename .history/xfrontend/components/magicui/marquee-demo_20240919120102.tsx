...
const ReviewCard = ({
  ...
  <figure
    className={cn(
      ...
      "text-gray-900 dark:text-white" // Dynamic text color based on theme
    )}
  >
...
<div className="relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden rounded-lg border bg-transparent dark:bg-transparent">
