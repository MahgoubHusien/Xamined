...
const ReviewCard = ({
  ...
  return (
    <figure
      className={cn(
        "relative w-64 cursor-pointer overflow-hidden rounded-xl border p-4 bg-white mx-4 my-2", // Added margin
...
export function MarqueeDemo() {
  return (
    <div className="relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden rounded-lg space-y-6"> {/* Added space-y-6 for vertical spacing */}
