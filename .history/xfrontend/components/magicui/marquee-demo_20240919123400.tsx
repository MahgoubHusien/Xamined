...
const ReviewCard = ({
  ...
  <figure
    className={cn(
      "relative w-full sm:w-64 cursor-pointer overflow-hidden rounded-xl border p-4 m-2",
      "border-gray-200 bg-white hover:bg-gray-100", // Light mode
      "dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700", // Dark mode (Twitter color theme)
...
export const MarqueeDemo = () => (
  <div className="relative flex flex-wrap h-[500px] w-full items-center justify-center overflow-hidden rounded-lg">
    <MarqueeComponent pauseOnHover className="[--duration:20s] flex-wrap">
      {firstRow.map((review) => (
        <ReviewCard key={review.username} {...review} />
      ))}
    </MarqueeComponent>
    <MarqueeComponent reverse pauseOnHover className="[--duration:20s] flex-wrap">
