...
const ReviewCard = ({
  ...
  <figure
    className={cn(
      "relative w-64 cursor-pointer overflow-hidden rounded-xl border p-4 m-4", // Adjusted margin to provide consistent spacing
...
export const MarqueeDemo = () => (
  <div className="relative flex h-[500px] w-full flex-col items-center justify-center overflow-hidden rounded-lg gap-4"> {/* Changed to gap-4 for equal spacing */}
    <MarqueeComponent pauseOnHover className="[--duration:20s]">
      <div className="flex space-x-4"> {/* Added space-x-4 for card spacing */}
        {firstRow.map((review) => (
