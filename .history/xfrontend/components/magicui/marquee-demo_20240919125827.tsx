...
const ReviewCard = ({ img, name, username, body }: { img: string; name: string; username: string; body: string; }) => (
  <figure
    className={cn(
      "relative h-40 w-36 cursor-pointer overflow-hidden rounded-xl border p-4 m-4",
...
export function MarqueeDemoVertical() {
  return (
    <div className="relative h-[500px] w-full overflow-hidden flex flex-row items-center justify-center">
      <div className="flex flex-col space-y-4 animate-marquee">
