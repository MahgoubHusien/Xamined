  ...
  const features = [
    {
      ...
      className:
        "col-span-12 md:col-span-4 row-span-1 border-b md:border-b-0 md:border-r dark:border-neutral-800",
    },
    {
      ...
      skeleton: <Chatbot />,
      className:
        "col-span-12 md:col-span-8 row-span-2 dark:border-neutral-800",
    },
    {
    ...
    },
    {
      ...
      className:
        "col-span-12 md:col-span-8 row-span-1 dark:border-neutral-800",
    },
  ];
  ...
  return (
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto">
      ...
      <div className="relative">
        <div className="grid grid-cols-12 grid-rows-2 gap-0 mt-12 xl:border rounded-md dark:border-neutral-800">
  ...
  return (
    <div className="flex flex-col items-start gap-4">
      <input
        ...
        className="w-full p-2 border border-neutral-300 dark:border-neutral-700 rounded-md bg-white dark:bg-neutral-900 text-black dark:text-white"
      />
      <button
...
export const Chatbot = () => {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex-1 overflow-auto mb-4 p-2 border border-neutral-300 dark:border-neutral-700 rounded-md bg-white dark:bg-neutral-900">
      ...
      <div className="flex">
        <input
          ...
          className="flex-1 p-2 border border-neutral-300 dark:border-neutral-700 rounded-md bg-white dark:bg-neutral-900 text-black dark:text-white"
        />
        <button
          onClick={handleSend}
