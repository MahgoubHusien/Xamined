...
import { Chatbot from "@/components/ui/Chatbot"; // Assuming you have a Chatbot component
...
const FeatureContainer = ({
  ...
  return (
    <div className="w-full md:w-1/3 p-4 bg-white border border-gray-200 rounded-lg shadow-lg">
      <div className="mb-4">
