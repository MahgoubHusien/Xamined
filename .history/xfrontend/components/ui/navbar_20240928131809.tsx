  ...
  return (
    ...
    >
      <div className="flex items-center justify-between px-8 py-4">
        {/* Left section: Title and Theme Toggle in mobile view */}
        <div className="flexspace-x-4 md:space-x-0">
          <Link
            href="/"
          ...
          {/* Show ThemeToggle only in mobile view */}
        ...
        {/* Right section: Theme Toggle for desktop view */}
