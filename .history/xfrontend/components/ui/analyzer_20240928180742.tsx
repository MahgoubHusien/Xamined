...
const FeatureContainer = ({
  ...
  return (
    <div className="w-full md:w-[30%] flex-shrink-0 p-6 bg-white border border-gray-200 rounded-lg shadow-lg h-[700px] md:h-[400px] flex flex-col justify-start items-center">
