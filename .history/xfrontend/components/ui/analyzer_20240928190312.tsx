...
const FeatureContainer = ({
  ...
  return (
    <div className="w-full md:w-[30%] flex-shrink-0 p-4 bg-white border border-gray-200 rounded-lg shadow-lg h-[00px] md:h-[500px] flex flex-col justify-start items-center">
