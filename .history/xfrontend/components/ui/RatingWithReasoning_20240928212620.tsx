...
export const RatingWithReasoning: React.FC<RatingWithReasoningProps> = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-neutral-800 rounded-lg shadow-lg p-6 w-full h-full max-w-md text-white">
      ...
      {/* Reasoning Section with Hidden Scrollbar */}
      <div className="w-full bg-neutral-700 rounded-lg p-4 border border-neutral-600 text-sm text-center min-h-[150px] max-h-[200px] overflow-y-auto scrollbar-hide">
        <p>{reasoning}</p>
      </div>
    </div>
  );
...
/* In your global CSS or a CSS module, add the following: */
