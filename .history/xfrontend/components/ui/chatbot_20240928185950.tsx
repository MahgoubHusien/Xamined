...
const Chatbot = () => {
  ...
  return (
    <div className="bg-gray-100 shadow-lg rounded-lg p-4 w-full max-w-md text-charcoal flex flex-col h-[400px]"> {/* Reduced height */}
      <div className="flex-1 overflow-y-auto mb-4 pr-2">
        {messages.map((msg, idx) => (
          <div key={idx} className={`mb-1 flex ${msg.sender === 'user' ? 'justify-end' : 'justify-start'}`}> {/* Minimized margin */}
