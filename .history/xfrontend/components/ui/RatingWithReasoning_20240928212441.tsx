  ...
  return (
    <div className="flex flex-col items-center justify-center bg-neutral-800 rounded-lg shadow-lg p-6 w-full h-full max-w-md text-white">
      ...
      <div className="flex items-center justify-center mb-4">
        <div className="relative flex items-center justify-center w-40 h-40"> {/* Increased size */}
      ...
      {/* Reasoning Section */}
      <div className="w-full bg-neutral-700 rounded-lg p-4 border border-neutral-600 text-sm text-center min-h-[150px] max-h-[200px] overflow-y-scroll">
        <p>{reasoning}</p>
      </div>
    </div>
  );
