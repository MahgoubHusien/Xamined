  ...
  const features = [
    {
      ...
      className:
        "col-span-12 md:col-span-6 row-span-1 border border-black",
    },
    {
      ...
      skeleton: <Chatbot />,
      className:
        "col-span-12 md:col-span-6 row-span-3 border border-black",
    },
    {
  ...
  return (
    <div className="relative py-10 lg:py-40 max-w-7xl mx-auto font-sans">
      ...
      <div className="relative">
        <div className="grid grid-cols-12 grid-rows-3 gap-0 mt-12 shadow-lg">
...
const FeatureTitle = ({ children }: { children?: React.ReactNode }) => {
  return (
    <p className="flex items-center text-left tracking-tight text-neutral-900 dark:text-neutral-100 text-2xl font-semibold">
      {children}
    </p>
  );
};
