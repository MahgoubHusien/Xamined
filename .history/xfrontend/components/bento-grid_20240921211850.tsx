  ...
  const features = [
    {
      ...
      className:
        "col-span-12 md:col-span-6 row-span-1 border-b md:border-b-0 border-r border-neutral-300 dark:border-neutral-700",
    },
    {
    ...
    },
    {
      ...
      className:
        "col-span-12 md:col-span-6 row-span-1 border-b border-r border-neutral-300 dark:border-neutral-700",
    },
    {
      ...
      className:
        "col-span-12 md:col-span-6 row-span-1 border-r border-neutral-300 dark:border-neutral-700",
    },
  ];

  return (
    <div className="relative z-20 py-10  max-w-7xl mx-auto font-sans">
      <div className="px-8">
