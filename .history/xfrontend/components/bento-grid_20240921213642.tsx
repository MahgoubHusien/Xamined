...
export function FeaturesSectionDemo() {
  const features = [
    ...
    {
      title: "Chat with Xaminer the GPT",
      description: "Discuss the tweet with Xaminer.",
      skeleton: <Chatbot />,
      className:
        "col-span-12 md:col-span-6 row-span-3 border-l border-neutral-300 dark:border-neutral-700 mt-4",
    },
    {
