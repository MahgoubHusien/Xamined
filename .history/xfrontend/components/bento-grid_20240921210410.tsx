...
const FeatureCard = ({
  ...
  return (
    <div
      className={cn(
        `p-4 sm:p-8 relative overflow-hidden font-sans`,
        className
      )}
    >
      {children}
  ...
  return (
    <div className="flex flex-col items-start gap-4 h-full">
      <input
        ...
        className="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-black text-black dark:text-white"
      />
      <button
...
export const Chatbot = () => {
  ...
  return (
    <div className="flex flex-col h-full font-sans">
      <div className="flex-1 overflow-auto mb-4 p-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-black">
