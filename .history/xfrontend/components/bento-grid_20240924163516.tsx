...
import { RatingWithReasoning } from "@/components/RatingWithReasoning"; // Import the new RatingWithReasoning component
  ...
  return (
    <div className="relative py-10 lg:py-20 max-w-7xl mx-auto font-sans">
      ...
      <div className="relative mt-12">
        <div className="grid grid-cols-12 grid-rows-3 gap-6 bg-white shadow-lg rounded-lg overflow-hidden">
...
const FeatureCard = ({
  ...
  return (
    <div
      className={cn(
        `p-4 sm:p-8 relative overflow-hidden h-full border border-gray-200`,
        className
      )}
    >
      {children}
