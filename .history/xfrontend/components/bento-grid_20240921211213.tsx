  ...
  const features = [
    {
      ...
      className:
        "col-span-12 md:col-span-6 row-span-1 border-b md:border-b-0 md:border-r border-neutral-200 dark:border-neutral-700",
    },
    {
      ...
      skeleton: <Chatbot />,
      className:
        "col-span-12 md:col-span-6 row-span-3 border-neutral-200 dark:border-neutral-700",
    },
    {
    ...
    },
    {
      ...
      className:
        "col-span-12 md:col-span-6 row-span-1 border-neutral-200 dark:border-neutral-700",
    },
  ];

  return (
    <div className="relative z-20 py-10 lg:py-40 max-w-7xl mx-auto font-sans bg-white dark:bg-neutral-900">
      <div className="px-8">
        <h4 className="text-3xl lg:text-5xl lg:leading-tight max-w-5xl mx-auto text-center tracking-tight font-semibold text-neutral-900 dark:text-neutral-100">
      ...
      <div className="relative">
        <div className="grid grid-cols-12 grid-rows-3 gap-0 mt-12 xl:border rounded-md border-neutral-200 dark:border-neutral-700">
...
const FeatureCard = ({
  ...
  return (
    <div
      className={cn(
        `p-4 sm:p-8 relative overflow-hidden bg-white dark:bg-neutral-900`,
        className
      )}
    >
      {children}
...
const FeatureTitle = ({ children }: { children?: React.ReactNode }) => {
  return (
    <p className="max-w-5xl mx-auto text-left tracking-tight text-neutral-900 dark:text-neutral-100 text-2xl font-semibold">
      {children}
    </p>
  );
};
  ...
  return (
    <div className="flex flex-col items-start gap-4 mt-4">
      <input
        ...
        className="w-full p-3 border border-neutral-300 dark:border-neutral-600 rounded-md bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 placeholder-neutral-500 dark:placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
      />
      <button
    ...
    <div className="flex flex-col h-full mt-4">
      ...
      <div className="flex">
        <input
          ...
          className="flex-1 p-3 border border-neutral-300 dark:border-neutral-600 rounded-md bg-white dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 placeholder-neutral-500 dark:placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
        <button
          onClick={handleSend}
          className="ml-2 px-6 py-3 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-colors duration-200"
        >
          Send
        </button>
      </div>
