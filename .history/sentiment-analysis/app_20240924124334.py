...
def analyze_sentiment(text):
    ...
    encoded_input = tokenizer(text, return_tensors='pt', clean_up_tokenization_spaces=True)  # Explicitly set clean_up_tokenization_spaces
...
if __name__ == '__main__':
    # Run the Flask app with debug mode set to False for production
