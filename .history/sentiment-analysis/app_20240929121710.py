...
# ChatGPT integration using the new OpenAI API format
def ask_chatgpt(prompt):
    try:
        response = openai.Completion.create(
            model=openai_model,  # Use the correct model name (e.g., "gpt-3.5-turbo")
            prompt=prompt,  # Pass the user prompt directly
